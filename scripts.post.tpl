...
/*
    ...
    Добавляем google-autocomplete в input для популярной CMS CS-Cart. 
    Также данный автокомплит выводит результаты городов по регионам, а не по стране (чего гугл пока не умеет).
    Также дополнительной особенностью этого автокомплита является то, что он заносит новые города, 
    выбранные через автокомплит в базу данных mysql через php.
